    ...
    buildStoriesFeedElement: function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if ( data.length ) {
            var dataObj = $(data);
            var duplicateStoryElement = null;
            ...
            for (var element in dataObj) {
              if (dataObj[element].id === topStoryId) {
                duplicateStoryElement = $storiesElement.find('article[id=' + topStoryId + ']')
              }
            }
            duplicateStoryElement ? duplicateStoryElement.remove() : $storiesElement.find('article').last().remove();
