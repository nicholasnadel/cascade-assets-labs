...
(function( $ ){
  ...
  ////////////////// ADDED FOR PROGRAM PAGE
  /**
   * Makes the ajax request for the program page.  Expects an html response
   */
  ChapmanEventsFeed.prototype.fetchProgramEvents = function() {
    $.ajax({
      method:  'GET',
      data:    { categories: this.categories },
      url:     this.fetchProgramPageEvents,
      headers: {'Access-Control-Allow-Origin': '*'},
      success: this.onFeaturedSuccess.bind(this),
      error:   this.onFeaturedError.bind(this)
    });
  ...
  ChapmanEventsFeed.prototype.onProgramEventSuccess = function(data) {
    var $event_cards = $(),
        $feed_column = $('<div class="feed-column"></div>'),
        self = this;
  ...
  ChapmanEventsFeed.prototype.onProgramEventFailure = function(message) {
