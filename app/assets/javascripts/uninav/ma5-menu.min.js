...
function ma5menu(atributes) {
  ...
  if ($(menuDesktop).length > 0) {
    var ma5menuHtml = '\n' +
      ...
      '            <span class="ma5menu__close"><i class="far fa-times-circle"></i></span>\n' +
      '        </a>\n' +
      '    </div>\n' +
      '</nav>\n' +
  ...
  if ($('.ma5menu').length > 0) {
    ...
    $('body').append('<div class="ma5menu__container wtfnick"><div class="ma5menu__head"></div><div class="ma5menu__alert"><div class="ma5menu__alert-content"><span class="ma5menu__icon-up" aria-hidden="true"></span><span class="ma5menu__icon-up" aria-hidden="true"></span><span class="ma5menu__icon-up" aria-hidden="true"></span></div></div></div>');
